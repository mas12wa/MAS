...
local selectweapon = tab:dropdown({
    Name = "Select Weapon",
...
tab:Toggle({
    Name = "Auto Farm",
    Callback = function(value)
        if _G.SelectedWeapon == nil and value == true then
            for i,v in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
                if v:IsA("Tool") then
...
spawn(function()
    while true do
        game:GetService("RunService").Stepped:Connect(function()
            pcall(function()
                if not game:GetService("Workspace"):FindFirstChild("MAS") then
                    local MAS = Instance.new("Part")
                    MAS.Name = "MAS"
                    MAS.Parent = game.Workspace
                    MAS.Anchored = true
                    MAS.Transparency = 0.8
                    MAS.Color = Color3.new(1, 1, 1)
                    MAS.Size = Vector3.new(10,0.5,10)
                    MAS.CanCollide = false
                elseif game:GetService("Workspace"):FindFirstChild("MAS") then
                    if _G.AutoFarm then
                        game.Workspace["MAS"].CanCollide = true
                        game.Workspace["MAS"].CFrame = CFrame.new(game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame.X, game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame.Y - 3.8, game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame.Z)
                    else 
                        game.Workspace["MAS"].CanCollide = false
                    end
                end
            end)
        end)
...
spawn (function()
    while true do
        if _G.AutoFarm then
            local lvl
            local level_folder = game:GetService("ReplicatedStorage").STATS
            local NPC_folder = game:GetService("Workspace").NPCS
            local quest_ui = game:GetService("Players").LocalPlayer.PlayerGui.Quest.Frame
            for i,v in pairs(level_folder:GetChildren()) do
            ...
            if lvl == 1 or lvl <= 9 then
                if quest_ui.Visible == false then
                    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("Workspace").Quests.Thug.CFrame
                    wait(.1)
                    game:GetService("ReplicatedStorage").Remotes.NPC.NPC:FireServer("Thug")
                elseif quest_ui.Visible == true then
                    for i,v in pairs(NPC_folder:GetChildren()) do
                        pcall(function()
                            if v.Name == "Thug#1" or v.Name == "Thug#2" or v.Name == "Thug#3" or v.Name == "Thug#4" or v.Name == "Thug#5" then
                                repeat wait()
                                    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = v.HumanoidRootPart.CFrame + Vector3.new(0, 20, 0)
                                    wait(.1)
                                    game:GetService("ReplicatedStorage").Remotes.DamageCombat:FireServer({v.Name,v.Name,v.Name,v.Name,v.Name,v.Name},_G.SelectedWeapon,"LeftPunch")
                                    game:GetService("ReplicatedStorage").Remotes.DamageCombat:FireServer({v.Name,v.Name,v.Name,v.Name,v.Name,v.Name},_G.SelectedWeapon,"RightPunch")
                                until v.Humanoid.Health <= 0 or _G.AutoFarm == false
                            end
                        end)
                    end
                end
            elseif lvl == 10 or lvl <= 24 then
                if quest_ui.Visible == false then
                    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("Workspace").Quests["Hamon User"].CFrame
                    wait(.1)
                    game:GetService("ReplicatedStorage").Remotes.NPC.NPC:FireServer("Hamon User")
                elseif quest_ui.Visible == true then
                    for i,v in pairs(NPC_folder:GetChildren()) do
                        pcall(function()
                            if v.Name == "Hamon User#1" or v.Name == "Hamon User#2" or v.Name == "Hamon User#3" or v.Name == "Hamon User#4" or v.Name == "Hamon User#5" then
                                repeat wait()
                                    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = v.HumanoidRootPart.CFrame + Vector3.new(0, 20, 0)
                                    wait(.1)
                                    game:GetService("ReplicatedStorage").Remotes.DamageCombat:FireServer({v.Name,v.Name,v.Name,v.Name,v.Name,v.Name},_G.SelectedWeapon,"LeftPunch")
            ...
            elseif lvl == 25 or lvl <= 44 then
                if quest_ui.Visible == false then
                    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("Workspace").Quests["Stone Mask User"].CFrame
                    wait(.1)
                    game:GetService("ReplicatedStorage").Remotes.NPC.NPC:FireServer("Stone Mask User")
                elseif quest_ui.Visible == true then
                    for i,v in pairs(NPC_folder:GetChildren()) do
                        pcall(function()
                            if v.Name == "Stone Mask User#1" or v.Name == "Stone Mask User#2" or v.Name == "Stone Mask User#3" or v.Name == "Stone Mask User#4" or v.Name == "Stone Mask User#5" then
                                repeat wait()
                                    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = v.HumanoidRootPart.CFrame + Vector3.new(0, 20, 0)
                                    wait(.1)
                                    game:GetService("ReplicatedStorage").Remotes.DamageCombat:FireServer({v.Name,v.Name,v.Name,v.Name,v.Name,v.Name},_G.SelectedWeapon,"LeftPunch")
            ...
            elseif lvl == 45 or lvl <= 64 then
                if quest_ui.Visible == false then
                    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("Workspace").Quests["Snow Thug"].CFrame
                    wait(.1)
                    game:GetService("ReplicatedStorage").Remotes.NPC.NPC:FireServer("Snow Thug")
                elseif quest_ui.Visible == true then
                    for i,v in pairs(NPC_folder:GetChildren()) do
                        pcall(function()
                            if v.Name == "Snow Thug#1" or v.Name == "Snow Thug#2" or v.Name == "Snow Thug#3" or v.Name == "Snow Thug#4" or v.Name == "Snow Thug#5" then
                                repeat wait()
                                    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = v.HumanoidRootPart.CFrame + Vector3.new(0, 20, 0)
                                    wait(.1)
                                    game:GetService("ReplicatedStorage").Remotes.DamageCombat:FireServer({v.Name,v.Name,v.Name,v.Name,v.Name,v.Name},_G.SelectedWeapon,"LeftPunch")
            ...
            elseif lvl == 65 or lvl <= 84 then
                if quest_ui.Visible == false then
                    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("Workspace").Quests.Snowman.CFrame
                    wait(.1)
                    game:GetService("ReplicatedStorage").Remotes.NPC.NPC:FireServer("Snowman")
                elseif quest_ui.Visible == true then
                    for i,v in pairs(NPC_folder:GetChildren()) do
                        pcall(function()
                            if v.Name == "Snowman#1" or v.Name == "Snowman#2" or v.Name == "Snowman#3" or v.Name == "Snowman#4" or v.Name == "Snowman#5" then
                                repeat wait()
                                    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = v.HumanoidRootPart.CFrame + Vector3.new(0, 20, 0)
                                    wait(.1)
                                    game:GetService("ReplicatedStorage").Remotes.DamageCombat:FireServer({v.Name,v.Name,v.Name,v.Name,v.Name,v.Name},_G.SelectedWeapon,"LeftPunch")
            ...
            elseif lvl == 85 or lvl <= 99 then
                if quest_ui.Visible == false then
                    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("Workspace").Quests["Snow Criminal"].CFrame
                    wait(.1)
                    game:GetService("ReplicatedStorage").Remotes.NPC.NPC:FireServer("Snow Criminal")
                elseif quest_ui.Visible == true then
                    for i,v in pairs(NPC_folder:GetChildren()) do
                        pcall(function()
                            if v.Name == "Snow Criminalr#1" or v.Name == "Snow Criminalr#2" or v.Name == "Snow Criminal#3" or v.Name == "Snow Criminal#4" or v.Name == "Snow Criminal#5" then
                                repeat wait()
                                    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = v.HumanoidRootPart.CFrame + Vector3.new(0, 20, 0)
                                    wait(.1)
                                    game:GetService("ReplicatedStorage").Remotes.DamageCombat:FireServer({v.Name,v.Name,v.Name,v.Name,v.Name,v.Name},_G.SelectedWeapon,"LeftPunch")
            ...
            elseif lvl == 100 or lvl <= 124 then
                if quest_ui.Visible == false then
                    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("Workspace").Quests["Desert Thug"].CFrame
                    wait(.1)
                    game:GetService("ReplicatedStorage").Remotes.NPC.NPC:FireServer("Desert Thug")
                elseif quest_ui.Visible == true then
                    for i,v in pairs(NPC_folder:GetChildren()) do
                        pcall(function()
                            if v.Name == "Desert Thug##1" or v.Name == "Desert Thug##2" or v.Name == "Desert Thug##3" or v.Name == "Desert Thug##4" or v.Name == "Desert Thug##5" then
                                repeat wait()
                                    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = v.HumanoidRootPart.CFrame + Vector3.new(0, 20, 0)
                                    wait(.1)
                                    game:GetService("ReplicatedStorage").Remotes.DamageCombat:FireServer({v.Name,v.Name,v.Name,v.Name,v.Name,v.Name},_G.SelectedWeapon,"LeftPunch")
            ...
            elseif lvl == 125 or lvl <= 149 then
                if quest_ui.Visible == false then
                    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("Workspace").Quests["Desert Monster"].CFrame
                    wait(.1)
                    game:GetService("ReplicatedStorage").Remotes.NPC.NPC:FireServer("Desert Monster")
                elseif quest_ui.Visible == true then
                    for i,v in pairs(NPC_folder:GetChildren()) do
                        pcall(function()
                            if v.Name == "Desert Monster#1" or v.Name == "Desert Monster#2" or v.Name == "Desert Monster#3" or v.Name == "Desert Monster#4" or v.Name == "Desert Monster#5" then
                                repeat wait()
                                    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = v.HumanoidRootPart.CFrame + Vector3.new(0, 20, 0)
                                    wait(.1)
                                    game:GetService("ReplicatedStorage").Remotes.DamageCombat:FireServer({v.Name,v.Name,v.Name,v.Name,v.Name,v.Name},_G.SelectedWeapon,"LeftPunch")
            ...
            elseif lvl == 150 or lvl <= 200 then
                if quest_ui.Visible == false then
                    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("Workspace").Quests["Desert Chimera"].CFrame
                    wait(.1)
                    game:GetService("ReplicatedStorage").Remotes.NPC.NPC:FireServer("Desert Chimera")
                elseif quest_ui.Visible == true then
                    for i,v in pairs(NPC_folder:GetChildren()) do
                        pcall(function()
                            if v.Name == "Desert Chimera#1" or v.Name == "Desert Chimera#2" or v.Name == "Desert Chimera#3" or v.Name == "Desert Chimera#4" or v.Name == "Desert Chimera#5" then
                                repeat wait()
                                    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = v.HumanoidRootPart.CFrame + Vector3.new(0, 20, 0)
                                    wait(.1)
                                    game:GetService("ReplicatedStorage").Remotes.DamageCombat:FireServer({v.Name,v.Name,v.Name,v.Name,v.Name,v.Name},_G.SelectedWeapon,"LeftPunch")
